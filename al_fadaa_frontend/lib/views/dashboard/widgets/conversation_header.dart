    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          // --- أزرار الإجراء السلسة والمفهومة ---

          // 1. زر إنجاز المهمة (يظهر فوراً عند وجود تكليف نشط للمعنيين أو للإدارة)
          ...
          // 3. زر إحالة (اختياري للإدارات)
          if (canAssign &&
              (item.status == 'RECEIVED' || item.status == 'UNDER_REVIEW' || item.status == 'REFERRED')) ...[
            OutlinedButton.icon(
