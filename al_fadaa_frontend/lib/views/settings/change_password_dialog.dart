...
/// الذي يبطل كل الجلسات الأخرى ويلزم بتسجيل الدخول من جديد.
...
class _ChangePasswordDialogState extends State<ChangePasswordDialog> {
  ...
  Future<void> _submit() async {
    ...
    final res = await ApiService().changePassword(_current.text, _newPass.text);
    if (!mounted) return;
    ...
    if (res['success'] == true) {
      ...
      AppEvents().triggerSessionExpired('تم تغيير كلمة المرور — سجّل الدخول من جديد');
    } else {
