...
export const metadata: Metadata = {
  title: "المدونة الهندسية والتقنية | مقالات وأخبار الفضاء الواسع باليمن",
  description: "مقالات، دراسات حالة، وإرشادات هندسية وتقنية متخصصة في مجالات المقاولات العامة، الاتصالات، التوريدات، وحلول الطاقة باليمن.",
  keywords: [
    "مدونة الفضاء الواسع",
    "مقالات مقاولات اليمن",
    "أخبار قطاع الاتصالات صنعاء",
    "دليل البناء والهندسة اليمن"
  ],
  alternates: {
        ...
        <section className="relative overflow-hidden bg-gradient-to-b from-navy-darker via-navy to-navy py-16 text-white sm:py-20">
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <nav className="mb-6 flex items-center gap-2 text-xs font-semibold text-white/70" aria-label="مسار التنقل">
              ...
              <span className="text-gold-light font-bold">المدونة الهندسية</span>
            </nav>
            ...
            <div className="max-w-3xl">
              ...
              <p className="mt-5 text-base leading-8 text-white/80 sm:text-lg">
                مقالات متخصصة، إرشادات هندسية، ودراسات فنية موجهة للمهتمين والشركاء في قطاعات المقاولات، الاتصالات، والتنمية في اليمن.
              </p>
            </div>
          </div>
        </section>
