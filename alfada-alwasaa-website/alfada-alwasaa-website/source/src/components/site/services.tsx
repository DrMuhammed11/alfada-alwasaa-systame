...
export function Services() {
  ...
  return (
    <section id="services" className="relative overflow-hidden bg-white dark:bg-navy-darker py-24 transition-colors duration-300">
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionHeading center kicker="منظومة عمل واحدة" title="خدماتنا" />

        {/* Tab Selector Header - Horizontal Scrollable Pill Navigation */}
        <Reveal delay={0.05} className="mb-10">
          <div className="flex items-center gap-2.5 overflow-x-auto pb-3 pt-1 scrollbar-none sm:justify-center">
            {SERVICES.map((service) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "group relative flex shrink-0 items-center gap-2 rounded-2xl px-4 py-2.5 text-xs sm:text-sm font-bold transition-all duration-300",
                    isActive
                      ? "bg-gold text-navy-darker shadow-lg shadow-gold/25 ring-1 ring-gold scale-105"
        ...
        <div className="relative">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="relative overflow-hidden rounded-3xl border border-navy/10 dark:border-white/10 bg-gradient-to-br from-navy via-navy-deep to-navy-darker p-6 sm:p-10 lg:p-12 text-white shadow-[0_25px_60px_-15px_rgba(5,30,49,0.7)]"
            >
              ...
              <div className="grid items-center gap-8 lg:grid-cols-12 lg:gap-12">
                ...
                <div className="flex flex-col justify-between lg:col-span-7">
                  <div>
                    ...
                    <div className="flex items-center gap-3">
                      <span className="flex h-12 w-12 items-center justify-center rounded-2xl bg-white/10 text-gold-light ring-1 ring-gold/40 shadow-inner">
                        <activeService.Icon className="h-6 w-6" strokeWidth={1.8} />
                      </span>
                    ...
                    <h3 className="mt-5 text-2xl sm:text-3xl lg:text-4xl font-black text-white leading-tight">
                      {activeService.title}
                    </h3>
                    <p className="mt-3 text-base sm:text-lg leading-8 text-white/85">
                      {activeService.desc}
                    </p>
                      ...
                      <div className="mt-6 border-t border-white/10 pt-5">
                        ...
                        <div className="mt-3 grid gap-2.5 sm:grid-cols-2">
                          {activeService.detail.features.slice(0, 4).map((feat, fIdx) => (
                            <div
                              key={fIdx}
                              className="flex items-start gap-2.5 rounded-xl bg-white/5 p-2.5 ring-1 ring-white/10"
                            >
                  ...
                  <div className="mt-8 flex flex-wrap items-center gap-3 pt-4 border-t border-white/10">
                    <Link
                      ...
                      className="inline-flex items-center gap-2 rounded-2xl bg-gold px-6 py-3 text-xs sm:text-sm font-black text-navy-darker shadow-lg transition-all duration-300 hover:bg-gold-light hover:scale-105 active:scale-95"
                    >
                    ...
                    <a
                      href="#contact"
                      className="inline-flex items-center gap-2 rounded-2xl bg-white/10 px-5 py-3 text-xs sm:text-sm font-bold text-white ring-1 ring-white/15 transition-all duration-300 hover:bg-white/20 hover:text-gold-light"
                    >
                ...
                <div className="relative lg:col-span-5">
                  <div className="relative aspect-[4/3] w-full overflow-hidden rounded-2xl border-2 border-gold/30 shadow-2xl bg-navy-darker">
